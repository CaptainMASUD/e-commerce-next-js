...
const Field = React.memo(function Field({ label, icon: Icon, rightSlot, children }) {
  return (
    <label className="grid gap-1.5">
      ...
      <div
        className={cx(
          "group flex h-11 items-center gap-2 overflow-hidden rounded-xl px-3 transition",
...
const PrimaryButton = React.memo(function PrimaryButton({ children, disabled, ...props }) {
  return (
    <button
      ...
      disabled={disabled}
      className={cx(
        "group relative mt-1 w-full overflow-hidden rounded-xl px-4 py-2.5 text-sm font-extrabold text-white",
        "focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2",
        disabled ? "cursor-not-allowed opacity-60" : "cursor-pointer"
      )}
      style={{
        background: `linear-gradient(180deg, ${PALETTE.navy} 0%, ${PALETTE.navy2} 100%)`,
        boxShadow: "0 14px 28px rgba(0,31,63,.20)",
      }}
    >
  ...
  return (
    <button
      ...
      style={{
        ...
        border: `1px solid ${PALETTE.border}`,
        color: PALETTE.navy,
        boxShadow: "0 8px 18px rgba(0,31,63,.06)",
      }}
    >
          ...
          <div className="absolute inset-0 flex items-center justify-center p-3 sm:p-4">
            <motion.div
              ...
              style={{
                ...
                border: `1px solid ${PALETTE.border}`,
                boxShadow: "0 20px 50px rgba(0,31,63,0.14)",
              }}
              onClick={(e) => e.stopPropagation()}
            >
              <div className="max-h-[82vh] overflow-y-auto">
                <section>
                  <div className="mx-auto w-full px-4 py-4 sm:px-5 sm:py-5">
                    <div
                    ...
                    >
                      <div className="flex items-start justify-between gap-3">
                        ...
                        <button
                          type="button"
                          onClick={() => onClose?.()}
                          className="inline-flex h-9 w-9 items-center justify-center rounded-lg cursor-pointer transition hover:opacity-90 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2"
                          style={{
                            background: "#ffffff",
                            border: `1px solid ${PALETTE.border}`,
                            color: PALETTE.navy,
                      ...
                      <div
                        className="mt-4 grid grid-cols-2 rounded-xl p-1"
                        style={{
                      ...
                      {mode === "login" ? (
                        <form className="mt-5 grid gap-3" onSubmit={handleLogin}>
                          ...
                          <div className="flex items-center justify-between gap-3">
                            <label
                              className="inline-flex cursor-pointer items-center gap-2 text-[11px] font-semibold"
                              style={{ color: PALETTE.muted }}
                            >
                              <input
                                type="checkbox"
                            ...
                            <button
                              ...
                              className="cursor-pointer text-[11px] font-semibold transition hover:opacity-90 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 rounded px-1"
                              style={{ color: PALETTE.muted }}
                            >
                              Forgot password?
                            </button>
                        ...
                        <form className="mt-5 grid gap-3" onSubmit={handleRegister}>
                          ...
                          <label
                            className="inline-flex cursor-pointer items-start gap-2 text-[11px] font-semibold"
                            style={{ color: PALETTE.muted }}
                          >
                            <input
                              type="checkbox"
